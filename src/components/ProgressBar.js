...
export default function ProgressBar({ found, total }) {
  ...
  // Anima suavemente ao encontrar cada palavra
  useEffect(() => {
  ...
  // Larguras absolutas de cada zona (relativas à barra inteira)
  ...
  return (
    ...
    >
      ...
      {/* Preenchimento animado — recorta as mesmas zonas com cores vivas */}
